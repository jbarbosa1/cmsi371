...
var Primitives = {
    ...
    circleTrig: function (context, xc, yc, r, color1, color2, color3, color4) {
        var theta = 1 / r,
    ...
    circleBres1: function (context, xc, yc, r, color1, color2, color3, color4) {
        var p = 3 - 2 * r,
            x = 0,
            y = r;
    ...
    // Last but not least...
    circleBres3: function (context, xc, yc, r, color1, color2, color3, color4) {
        var x = r,
            y = 0,
            e = 0;
