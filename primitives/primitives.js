...
var Primitives = {
    ...
    plotCirclePoints: function (context, xc, yc, x, y, r, color1, color2, color3, color4) {
        var lColor = color1 ? [color1[0], color1[1], color1[2]] : color1,
        rColor = color2 ? [color2[0], color2[1], color2[2]] : color2,
        cColor;
        ...
        if (color2 == undefined) {
            ...
            for (var i = -x; i < x; i++) {
                currentColor = [lColor[0], lColor[1], lColor[2]];
                ...
                lColor[1] += rVDelta[1];
                lColor[2] += rVDelta[2];
                // this.setPixel(context, xc - i, yc + y, (((color1[0] * posY) + color2[0] * negY) + ((color3[0] * posY) + color4[0] * negY)),
                //                                        (((color1[1] * posY) + color2[1] * negY) + ((color3[1] * posY) + color4[1] * negY)),
                //                                        (((color1[2] * posY) + color2[2] * negY) + ((color3[2] * posY) + color4[2] * negY)));
                // this.setPixel(context, xc - i, yc - y, (((color1[0] * negY) + color2[0] * posY) + ((color3[0] * negY) + color4[0] * posY)), 
                //                                        (((color1[1] * negY) + color2[1] * posY) + ((color3[0] * negY) + color4[0] * posY)), 
                //                                        (((color1[2] * negY) + color2[2] * posY) + ((color3[0] * negY) + color4[0] * posY)));
            }
